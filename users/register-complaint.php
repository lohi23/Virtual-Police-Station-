...
<html lang="en">
  <head>
    ...
    <title>VPS | User Register Complaint</title>
...
<label class="col-sm-2 col-sm-2 control-label">More Details </label>
 <div class="col-sm-4">
<select name="subcategory" id="subcategory" class="form-control" >
<option value="subcategorey">Select Subcategory</option>
<select name="subcategorey" id="subcategorey" class="form-control" >
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Complaint</option>
                  ...
                  <option value="First Informtion Report">First Informtion Report</option>
                </select> 
</div>

<label class="col-sm-2 col-sm-2 control-label">Station</label>
<div class="col-sm-4">
<select name="station" required="required" class="form-control">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Summary of Complaint</label>
<div class="col-sm-4">
