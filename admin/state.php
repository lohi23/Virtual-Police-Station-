...
if(isset($_GET['del']))
		  {
		          mysqli_query($bd, "delete from state where id = '".$_GET['id']."'");
...
<label class="control-label" for="basicinput">Station Name</label>
<div class="controls">
<input type="text" placeholder="Enter Station Name"  name="state" class="span8 tip" required>
</div>
</div>
